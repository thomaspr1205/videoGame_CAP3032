class Menu{
    ...
    void displayCredits() {
        ...
        fill(255);
        text("CREATED BY:", 500,180);
        textSize(20);
        text("AARON SONG & THOMAS PENA", 500, 210);
        textSize(30);
        text("MUSIC BY:",500,250);
        textSize(20);
        text("ABSTRACTION @ http://www.abstractionmusic.com/", 500, 280);
        textSize(30);
        text("CHARACTER ART BY:",500,320);
        textSize(20);
        text("ARKS @ arks.digital", 500, 350);
        textSize(30);
        text("TEXTURES BY:",500,390);
        textSize(20);
        text("PiiiXL @ https://piiixl.itch.io/textures", 500, 420);
        textSize(30);
        text("SOUND EFFECTS BY:",500,460);
        textSize(20);
        text("dave.des @ https://pixabay.com/sound-effects/fast-simple-chop-5-6270/", 500, 490);
        text("NicknameLarry @ https://pixabay.com/sound-effects/monster-roar-6985/", 500, 520);
        textSize(30);
        text("OTHER ICONS BY:",500,560);
        textSize(20);
        text("7da631 @ http://pixelartmaker.com/art/1f923d1c3a1f8b0", 500, 590);
        text("75a299 @ http://pixelartmaker.com/art/684798e0915e233", 500, 620);
        text("https://tinyurl.com/yx4epcny", 500, 650);
    }
}
